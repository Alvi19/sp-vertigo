...
<script src="<?php echo base_url('vendor/admin/'); ?>vendor/chart.js/Chart.min.js"></script>
<script src="<?php echo base_url('vendor/admin/'); ?>js/demo/chart-area-demo.js"></script>
<script src="<?php echo base_url('vendor/admin/'); ?>js/demo/chart-pie-demo.js"></script>
</body>
