...
<!-- <script src="<?php echo base_url('vendor/admin/'); ?>vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url('vendor/admin/'); ?>vendor/datatables/dataTables.bootstrap4.min.js"></script> -->
