      ...
      <div class="container">
         <div class="row gy-4">
            ...
            <!-- <div class="col-lg-2 col-6 footer-links">
               <h4>Useful Links</h4>
               <ul>
                  <li><i class="bi bi-chevron-right"></i> <a href="<?php echo base_url('home'); ?>">Home</a></li>
                  <li><i class="bi bi-chevron-right"></i> <a href="<?php echo base_url('diagnosa'); ?>">Diagnosa</a></li>
                  <li><i class="bi bi-chevron-right"></i> <a href="<?php echo base_url('penyakit'); ?>">Penyakit</a></li>
